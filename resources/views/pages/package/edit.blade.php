        ...
        <div class="card shadow-none">
            <div class="card-header">
                <div class="row flex-between-center">
                    <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                        <h2 class="fs-6 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-box me-1"></i> Edit Package: {{ $package->name }}</h2>
                    </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.packages.update', $package->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <x-forms.text-input name="name" label="Package Name" :value="old('name', $package->name)" required
                                help="Enter a descriptive name for this package (e.g., Pro Plan, Business Tier)"/>
                        </div>

                        <div class="col-md-6">
                            <x-forms.text-input name="type" label="Package Type" :value="old('type', $package->type)"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <x-forms.text-input name="price" label="Price ($)" :value="old('price', $package->price)" required type="number"
                                step="0.01" min="0.00" help="Enter the package price in dollars"/>
                        </div>

                        <div class="col-md-3">
                            <x-forms.text-input name="renew_price" label="Renewal Price ($)" :value="old('renew_price', $package->renew_price)" required
                                type="number" step="0.01" min="0.00" help="Enter the renewal price in dollars"/>
                        </div>

                        <div class="col-md-3">

                            <x-forms.select name="interval" label="Billing Interval" :options="$intervals" :value="old('interval', $package->interval)" required
                                help="Select the billing interval period"/>
                        </div>

                        <div class="col-md-3">
                            <x-forms.text-input name="interval_count" label="Interval Count" :value="old('interval_count', $package->interval_count)" required
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <x-forms.textarea name="description" label="Description" :value="old('description', $package->description)"
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" id="auto_renew" name="auto_renew" value="1"
                                    {{ old('auto_renew', $package->auto_renew) ? 'checked' : '' }}>
