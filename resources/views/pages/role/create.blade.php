        ...
        <div class="card shadow-none">
            <div class="card-header">
                <div class="row flex-between-center">
                    <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                        <h2 class="fs-6 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-user-shield me-1"></i> Create New Role</h2>
                    </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.roles.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <x-forms.text-input name="name" label="Role Name" :value="old('name')" required help="Enter a descriptive name for this role (e.g., Editor,
                                Author, Manager)"/>
                        </div>
                    </div>
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        <div
                                            ...
                                            <strong>{{ $module ?Str::ucfirst(str_replace('-', ' ', $module)): 'General' }}</strong>
                                            <div>
                                                <button type="button"
