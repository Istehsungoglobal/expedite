<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="../index.html">
        <div class="d-flex align-items-center"><img class="me-2" src="{{ asset('assets/images/favicons/logo.png') }}"
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        <li class="nav-item ps-2 pe-0">
            <div class="dropdown theme-control-dropdown"><a
                    ...
                    href="navbar-vertical.html#" role="button" id="themeSwitchDropdown" data-bs-toggle="dropdown"
                ...
                <div class="card card-notification shadow-none">
                    <div class="card-header">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-auto ps-0 ps-sm-3"><a class="card-link fw-normal"
                                    href="navbar-vertical.html#">Mark all as read</a></div>
                        </div>
                    </div>
                    <div class="scrollbar-overlay" style="max-height:19rem">
                        <div class="list-group list-group-flush fw-normal fs-10">
                            ...
                            <div class="list-group-item">
                                <a class="notification notification-flush" href="navbar-vertical.html#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-2xl me-3">
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                ...
                <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="{{ asset('assets/images/team/3-thumb.png') }}" alt="" />
                </div>
            </a>
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                aria-labelledby="navbarDropdownUser">
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    <a class="dropdown-item fw-bold text-warning" href="navbar-vertical.html#!"><span
                            class="fas fa-crown me-1"></span><span>Go Pro</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="navbar-vertical.html#!">Set status</a>
                    <a class="dropdown-item" href="{{ route('admin.user.profile') }}">Profile &amp;
                        account</a>
                    <div class="dropdown-divider"></div>
