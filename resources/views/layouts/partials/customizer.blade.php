    ...
    <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="row gx-2">
                <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio"
                        ...
                        class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('assets/images/generic/falcon-mode-default.jpg') }}" alt="" /></span><span
                ...
                <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio"
                        ...
                        class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('assets/images/generic/falcon-mode-dark.jpg') }}" alt="" /></span><span
                ...
                <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio"
                        ...
                        class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('assets/images/generic/falcon-mode-auto.jpg') }}" alt="" /></span><span
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2"
                    src="{{ asset('assets/images/icons/left-arrow-from-left.svg') }}" width="20" alt="" />
                <div class="flex-1">
